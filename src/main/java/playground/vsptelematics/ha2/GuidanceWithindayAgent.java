...
public class GuidanceWithindayAgent implements MobsimDriverAgent {
	...
	protected GuidanceWithindayAgent( Person p, Netsim simulation, Guidance guidance, TimeInterpretation timeInterpretation ) {
		this.simulation = simulation;
		this.guidance = guidance;
		this.delegate = new PersonDriverAgentImpl(p.getSelectedPlan(), simulation, timeInterpretation) ;
	}
